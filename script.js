...
const marker4 = L.marker([54.90989,-1.38298]).addTo(map)
		.bindPopup('<b>WearmouthBridge</b><br />It is a nice bridge and it is fun to watch the trains on the other bridge.');
